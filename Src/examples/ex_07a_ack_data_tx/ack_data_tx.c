 ...
 *
 *           This is a simple code example that sends a frame and then turns on the DW IC receiver to receive a response, expected to be an ACK
 ...
 *     */
static uint8_t tx_msg[] = { 0x61, 0x88, 0, 0xCA, 0xDE, 'X', 'R', 'X', 'T', 'm', 'a', 'c', 
    'p', 'a', 'y', 'l', 'o', 'a', 'd' };
