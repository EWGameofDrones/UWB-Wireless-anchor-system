...
TITLE_TYPE = "3 anchors: 1 responder: " + Hz1 + ", "+ Hz2 +", "+ Hz3 +" Hz"
            ...
            if case == 'A':
                ...
                if firstC:
                    ...
                    if current_val - prevC > 1:
                        ...
                        droppedC += current_val - prevC
                    prevC = current_val
                receivedC += 1
            else:
                print("Invalid case: ", case)

# print("Total A: ", receivedA)
# print("Total B: ", receivedB)
# print("Total C: ", receivedC)
# print("Total: ", receivedA + receivedB + receivedC)
# print("Dropped A: ", droppedA)
# print("Dropped B: ", droppedB)
# print("Dropped C: ", droppedC)
# print("Dropped: ", droppedA + droppedB + droppedC)
